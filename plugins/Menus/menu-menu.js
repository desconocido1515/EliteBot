...
const videoPath = path.join(process.cwd(), 'media', 'menugeneral.mp4')
const videoBuffer = fs.readFileSync(videoPath)

try {
await conn.sendMessage(m.chat, { video: videoBuffer, gifPlayback: true, caption: menu, mentions: [m.sender, global.conn.user.jid] }, { quoted: fkontak }) 
} catch (error) {
