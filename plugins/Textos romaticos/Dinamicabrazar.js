...
let handler = async (m, { conn, usedPrefix, command, text }) => {
    ...
    try {
        ...
        if (!user) {
            return conn.reply(m.chat, `⚠️ No encontré a quién mencionas.`, m, rcanal);
        }
...
*@${userName}*
 𝙏𝙀 𝘿𝙄𝙀𝙍𝙊𝙉 𝙐𝙉 𝘼𝘽𝙍𝘼𝙕𝙊. 🫂
        ...
        const images = [
            'https://telegra.ph/file/899eb3e64097ff236113f.jpg',
        ...
        await conn.reply(m.chat, `❌ Hubo un error ejecutando el comando.`, m, rcanal);
    }
}
